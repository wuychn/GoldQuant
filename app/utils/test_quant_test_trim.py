...
from common.testing.trim import maybe_trim_for_test_phase, trim_for_test_phase
...
class QuantTestTrimTests(unittest.TestCase):
    ...
    @patch("common.config.get_settings")
    ...
    def test_test_phase_list_limit(self, mock_get_settings) -> None:
        from common.testing.trim import test_phase_list_limit
