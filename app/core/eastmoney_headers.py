...
def _patched_session_request(self: Session, method: str, url: str | bytes, **kwargs: Any) -> Any:
    ...
    if extra:
        if "https://push2.eastmoney.com" in url_s or "https://33.push2.eastmoney.com/api/qt/clist/get" in url_s or "https://push2his.eastmoney.com/api/qt/stock/kline/get" in url_s or "https://82.push2.eastmoney.com/api/qt/clist/get" in url_s:
