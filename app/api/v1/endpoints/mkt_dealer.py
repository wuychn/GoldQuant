...
async def em_lhb_detail(
    ...
    return Response(data=_ak("stock_lhb_detail_em", p, df))
...
async def em_lhb_stock_statistic(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_stock_statistic_em", p, df))
...
async def em_lhb_jgmmtj(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_jgmmtj_em", p, df))
...
async def em_lhb_jgstatistic(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_jgstatistic_em", p, df))
...
async def em_lhb_hyyyb(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_hyyyb_em", p, df))
...
async def em_lhb_yyb_detail(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_yyb_detail_em", p, df))
...
async def em_lhb_yybph(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_yybph_em", p, df))
...
async def em_lhb_trader_statistic(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_traderstatistic_em", p, df))
...
async def em_lhb_stock_detail(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_stock_detail_em", p, df))
...
async def ths_lh_yyb_most() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_lh_yyb_most)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lh_yyb_most", {}, df))
...
async def ths_lh_yyb_capital() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_lh_yyb_capital)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lh_yyb_capital", {}, df))
...
async def ths_lh_yyb_control() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_lh_yyb_control)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lh_yyb_control", {}, df))
...
async def sina_lhb_detail_daily(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_detail_daily_sina", p, df))
...
async def sina_lhb_ggtj(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_ggtj_sina", p, df))
...
async def sina_lhb_yytj(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_yytj_sina", p, df))
...
async def sina_lhb_jgzz(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_jgzz_sina", p, df))
...
async def sina_lhb_jgmx() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_lhb_jgmx_sina)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_lhb_jgmx_sina", {}, df))
