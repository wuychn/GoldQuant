...
async def em_hsgt_fund_flow_summary() -> AkTableOut:
    try:
        df = await run_in_threadpool(ak.stock_hsgt_fund_flow_summary_em)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_fund_flow_summary_em", {}, df)
...
async def em_hsgt_fund_min(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_fund_min_em", p, df)
...
async def em_hsgt_board_rank(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_board_rank_em", p, df)
...
async def em_hsgt_hold_stock(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_hold_stock_em", p, df)
...
async def em_hsgt_stock_statistics(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_stock_statistics_em", p, df)
...
async def em_hsgt_institution_statistics(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_institution_statistics_em", p, df)
...
async def em_hsgt_sh_hk_spot() -> AkTableOut:
    try:
        df = await run_in_threadpool(ak.stock_hsgt_sh_hk_spot_em)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_sh_hk_spot_em", {}, df)
...
async def em_hsgt_hist(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_hist_em", p, df)
...
async def em_hsgt_individual(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_individual_em", p, df)
...
async def em_hsgt_individual_detail(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return _ak("stock_hsgt_individual_detail_em", p, df)
