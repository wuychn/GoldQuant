...
async def em_fund_individual(
    ...
    return Response(data=_ak("stock_individual_fund_flow", p, df))
...
async def em_fund_individual_rank(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_individual_fund_flow_rank", p, df))
...
async def em_fund_market() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_market_fund_flow)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    # 只返回最近5天的数据
    return Response(data=dataframe_to_records(df)[-5:])
...
async def em_fund_sector_rank(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_sector_fund_flow_rank", p, df))
...
async def em_fund_main(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_main_fund_flow", p, df))
...
async def em_fund_sector_summary(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_sector_fund_flow_summary", p, df))
...
async def em_fund_sector_hist(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_sector_fund_flow_hist", p, df))
...
async def em_fund_concept_hist(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_concept_fund_flow_hist", p, df))
...
async def ths_fund_flow_individual(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_fund_flow_individual", p, df))
...
async def ths_fund_flow_concept(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_fund_flow_concept", p, df))
...
async def ths_fund_flow_industry(
    ...
    try:
        ...
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_fund_flow_industry", p, df))
...
async def ths_fund_flow_big_deal() -> Response:
    try:
        df = await run_in_threadpool(ak.stock_fund_flow_big_deal)
    except Exception as exc:
        raise HTTPException(status_code=502, detail=str(exc)) from exc
    return Response(data=_ak("stock_fund_flow_big_deal", {}, df))
