...
from quant.push.format import ICON_HOLD, fmt_price, icon_section, money
...
def paper_block(title: str = "纸面账户") -> str:
    return icon_section(ICON_HOLD, title, paper_account_lines() + paper_holdings_lines())
