...
from quant.narrative.news_format import format_news_for_push
...
def run_news(raw: dict, *, timestamp: str) -> str:
    ...
    summary = call_llm(prompt_news(), user, max_tokens=12000) or ""
    summary = format_news_for_push(summary, max_items=30)
    news_summary_text = ""
    if "综合解读" in summary:
