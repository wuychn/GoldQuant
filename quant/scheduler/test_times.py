...
from quant.scheduler.times import build_during_market_schedule
...
class DuringMarketScheduleTests(unittest.TestCase):
    def test_default_seven_minute_sessions(self) -> None:
        ...
        self.assertEqual(times[0], "09:37")
        self.assertEqual(times[16], "11:29")
        self.assertEqual(times[17], "13:00")
        self.assertEqual(times[-1], "14:59")
        self.assertEqual(len(times), 35)
