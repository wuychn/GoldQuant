...
from quant.trading.sell_policy import (
...
class SellPolicyTests(unittest.TestCase):
    ...
    @patch("quant.trading.sell_policy.trend_broken_for_stop", return_value=False)
    ...
    @patch("quant.trading.sell_policy.trend_broken_for_stop", return_value=True)
    @patch("quant.trading.sell_policy.is_late_session_for_trend_sell", return_value=False)
    ...
    @patch("quant.trading.sell_policy.trend_broken_for_stop", return_value=True)
    @patch("quant.trading.sell_policy.is_late_session_for_trend_sell", return_value=True)
    ...
    def test_stop_when_trend_broken_and_pnl_bad(self, _brk) -> None:
        ...
        stock = {"盘口": {"涨幅": -4.0, "最新": 9.0}}
        with patch(
            "quant.trading.sell_policy.is_late_session_for_trend_sell",
            return_value=True,
        ):
    ...
    @patch("quant.trading.sell_policy.limit_pct", return_value=9.9)
    @patch("quant.trading.sell_policy.load_trade_sim_config")
