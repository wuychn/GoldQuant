...
from quant.candidates.pipeline import run_candidate_pipeline
from quant.candidates.source_merge import merge_prefiltered_sources, split_enriched_by_source
from quant.candidates.sources import (
    merge_ths_rank_from_batches,
    prefilter_popularity,
    prefilter_ths_rank,
    prefilter_zt_pool,
)
from quant.candidates.ths_rank_util import split_enriched_ths_rank_payload
...
async def _prefilter_popularity(settings: Settings, cfg: dict) -> list[dict]:
    from quant.candidates.candidate_config import popularity_limit
