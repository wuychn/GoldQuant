...
from quant.r2.domain.models import RegimeSnapshot
from quant.r2.market.regime import detect_regime
from quant.r2.signals.entry import generate_buy_signals
from quant.r2.signals.exit import generate_sell_signals
