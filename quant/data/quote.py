"""盘口 / 历史行情字段统一读取（纯价格工具，无业务语义）。

从 ``quant.scoring.tech_indicators`` 迁出：r1 评分体系退役后，这些纯价函数被
factors / execution / portfolio / store / pool 共用，独立成底层模块。
兼容中文键、英文键与归档 computed 格式。
"""
